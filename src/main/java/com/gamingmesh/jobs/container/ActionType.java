...
public enum ActionType {
	...
	CUSTOMCROPSPLANT("CustomCropsPlant", CMIMaterial.WHEAT_SEEDS, ActionSubType.CUSTOM),
	CUSTOMCROPSHARVEST("CustomCropsHarvest", CMIMaterial.WHEAT, ActionSubType.CUSTOM),
	CUSTOMCROPSWATER("CustomCropsWater", CMIMaterial.WATER_BUCKET, ActionSubType.CUSTOM);
